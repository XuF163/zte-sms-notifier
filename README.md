...
## 使用
0. 前往options.js line53改成自己的路由器密码
1. 点击扩展图标打开 Popup
2. 点击「⚙️ 设置」进入选项页
3. 配置：
...
- 轮询使用 `chrome.alarms`，最小间隔为 10 秒； 请使用开发者身份加载扩展
- `manifest.json` 目前仅声明了 `192.168.0.1`  两个地址的访问权限；如果你的路由器是其它地址，需要相应调整 `host_permissions`。
- 纯本地程序，有修改需求自己让AI上手
